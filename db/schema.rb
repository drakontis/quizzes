...
ActiveRecord::Schema.define(version: 20171028124326) do
  ...
  create_table "answers", force: :cascade do |t|
    t.integer "taken_quiz_id", null: false
    t.integer "question_id",   null: false
    t.integer "choice_id",     null: false
    t.index ["choice_id"], name: "index_answers_on_choice_id", using: :btree
    t.index ["question_id"], name: "index_answers_on_question_id", using: :btree
    t.index ["taken_quiz_id"], name: "index_answers_on_taken_quiz_id", using: :btree
  end
  ...
  add_foreign_key "answers", "taken_quizzes"
